...
const Section03 = () => {
    ...
    return (
       ...
       <div ref={el => sectionsRef.current[0] = el} className=' w-full h-full mx-auto mb-20 bg-black'>
           <div className="bg-white m-20 overflow-hidden pt-20 pb-20 pl-12 pr-12 rounded-[20px] shadow-[0px_0px_30px_rgba(0,0,0,0.3)]">
               <div className='max-[1080px]:flex-col flex items-end justify-between'>
                    <div className='max-[1080px]:mx-auto max-[1080px]:items-center max-xl:text-center flex flex-col max-xl:items-start justify-between h-full text-[100px] overflow-hidden'>
                        <em style={{ fontStyle: "italic", color: "transparent", lineHeight: "1", WebkitTextStroke: "1px #7e1800", }} className='max-xl: max-[540px]:text-[0.6em] max-xl:text-[0.8em] max-xl:mb-[0.3em] text-[1.2em] libre-baskerville-regular '>01</em>
                        <div>
                            <h3 style={{  letterSpacing: "-0.04em", fontWeight: "600", lineHeight: "1.2", }} className='max-[1080px]:text-center max-xl:text-left max-[540px]:text-[22px] max-[1450px]:text-[34px] text-[max(.4em,22px)] text-[#601301] poppins-bold'>
                    ...
                    <div className='max-[1080px]:mx-auto max-[768px]:w-full max-[1600px]:w-[460px] relative flex items-center justify-center'>
               ...
               <p className='max-xl:hidden tracking-[-0.03em] leading-[1.7] text-[#c3c3c3] text-[24px] libre-baskerville-regular-italic pt-8'>
           ...
           <div className="bg-white m-20 overflow-hidden pt-20 pb-20 pl-12 pr-12 rounded-[20px] shadow-[0px_0px_30px_rgba(0,0,0,0.3)]">
               <div className='max-[1080px]:flex-col flex items-end justify-between'>
                    <div className='max-[1080px]:items-center max-[1080px]:mx-auto max-xl:items-start max-xl:text-center flex flex-col items-start justify-between h-full text-[100px] overflow-hidden'>
                        <em style={{ fontStyle: "italic", color: "transparent", lineHeight: "1", WebkitTextStroke: "1px #7e1800", }} className='max-[540px]:text-[0.6em] text-[1.2em] max-xl:text-[0.8em] max-xl:mb-[0.3em] libre-baskerville-regular'>02</em>
                        <div>
                            <h3 style={{  letterSpacing: "-0.04em", fontWeight: "600", lineHeight: "1.2", }} className='max-[1080px]:text-center max-xl:text-left max-[540px]:text-[22px] max-[1450px]:text-[34px] text-[#601301] poppins-bold text-[max(.4em,22px)]'>
               ...
               <p className='max-xl:hidden tracking-[-0.03em] leading-[1.7] text-[#c3c3c3] text-[24px] libre-baskerville-regular-italic pt-8'>
                ...
                With the help of Ron and Hermione, he discovers that the chamber has been opened before and is connected to a monster that can kill with a single glance.
       ...
       <div ref={el => sectionsRef.current[2] = el} className='w-full h-full mx-auto mb-20'>
           <div className="bg-white m-20 overflow-hidden pt-20 pb-20 pl-12 pr-12 rounded-[20px] shadow-[0px_0px_30px_rgba(0,0,0,0.3)]">
               <div className='max-[1080px]:flex-col flex items-end justify-between'>
                    <div className='max-[1080px]:items-center max-[1080px]:mx-auto max-xl:items-start max-xl:text-center flex flex-col items-start justify-between h-full text-[100px] overflow-hidden'>
                        <em style={{ fontStyle: "italic",  color: "transparent", lineHeight: "1", WebkitTextStroke: "1px #7e1800", }} className='max-[540px]:text-[0.6em] text-[1.2em] max-xl:text-[0.8em] max-xl:mb-[0.3em] libre-baskerville-regular'>03</em>
                        <div>
                            <h3 style={{ letterSpacing: "-0.04em", fontWeight: "600", lineHeight: "1.2", }} className='max-[1080px]:text-center max-xl:text-left max-[540px]:text-[22px] max-[1450px]:text-[34px] text-[max(.4em,22px)] text-[#601301] poppins-bold'>
       ...
       <div ref={el => sectionsRef.current[3] = el} className='w-full h-full mx-auto mb-20'>
           <div className="bg-white m-20 overflow-hidden pt-20 pb-20 pl-12 pr-12 rounded-[20px] shadow-[0px_0px_30px_rgba(0,0,0,0.3)]">
               <div className='max-[1080px]:flex-col flex items-end justify-between'>
                    <div className='max-[1080px]:items-center max-[1080px]:mx-auto max-xl:items-start max-xl:text-center flex flex-col items-start justify-between h-full text-[100px] overflow-hidden'>
                        <em style={{ fontStyle: "italic",  color: "transparent", lineHeight: "1", WebkitTextStroke: "1px #7e1800", }} className='max-[540px]:text-[0.6em] text-[1.2em] max-xl:text-[0.8em] max-xl:mb-[0.3em] libre-baskerville-regular'>04</em>
                        <div>
                            <h3 style={{ letterSpacing: "-0.04em", fontWeight: "600", lineHeight: "1.2", }} className='max-[1080px]:text-center max-xl:text-left max-[540px]:text-[22px] max-[1450px]:text-[34px] text-[max(.4em,22px)] text-[#601301] poppins-bold'>
       ...
       <div ref={el => sectionsRef.current[4] = el} className='w-full h-full mx-auto mb-20'>
            <div className="bg-white m-20 overflow-hidden pt-20 pb-20 pl-12 pr-12 rounded-[20px] shadow-[0px_0px_30px_rgba(0,0,0,0.3)]">
               <div className='max-[1080px]:flex-col flex items-end justify-between'>
                    <div className='max-[1080px]:items-center max-[1080px]:mx-auto max-xl:items-start max-xl:text-center flex flex-col items-start justify-between h-full text-[100px] overflow-hidden'>
                        <em style={{ fontStyle: "italic",color: "transparent", lineHeight: "1", WebkitTextStroke: "1px #7e1800", }} className='max-[540px]:text-[0.6em] text-[1.2em] max-xl:text-[0.8em] max-xl:mb-[0.3em] libre-baskerville-regular'>05</em>
                        <div>
                            <h3 style={{  letterSpacing: "-0.04em", fontWeight: "600", lineHeight: "1.2", }} className='max-[1080px]:text-center max-xl:text-left max-[540px]:text-[22px] max-[1450px]:text-[34px] text-[max(.4em,22px)] text-[#601301] poppins-bold'>
                    ...
                    <div className='max-[1080px]:mx-auto max-[768px]:w-[360px] max-[1600px]:w-[460px] relative flex items-center justify-center'>
       ...
       <div ref={el => sectionsRef.current[5] = el} className='w-full h-full mx-auto mb-20'>
           <div className="bg-white m-20 overflow-hidden pt-20 pb-20 pl-12 pr-12 rounded-[20px] shadow-[0px_0px_30px_rgba(0,0,0,0.3)]">
               <div className='max-[1080px]:flex-col flex items-end justify-between'>
                <div className='max-[1080px]:items-center max-[1080px]:mx-auto max-xl:items-start max-xl:text-center flex flex-col items-start justify-between h-full text-[100px] overflow-hidden'>
                    <em style={{ fontStyle: "italic", color: "transparent", lineHeight: "1", WebkitTextStroke: "1px #7e1800", }} className='max-[540px]:text-[0.6em] text-[1.2em] max-xl:text-[0.8em] max-xl:mb-[0.3em] libre-baskerville-regular'>06</em>
                    <div>
                        <h3 style={{  letterSpacing: "-0.04em", fontWeight: "600", lineHeight: "1.2", }} className='max-[1080px]:text-center max-xl:text-left max-[540px]:text-[22px] max-[1450px]:text-[34px] text-[max(.4em,22px)] text-[#601301] poppins-bold'>
       ...
       <div ref={el => sectionsRef.current[6] = el} className='w-full h-full mx-auto mb-20'>
           <div className="bg-white m-20 overflow-hidden pt-20 pb-20 pl-12 pr-12 rounded-[20px] shadow-[0px_0px_30px_rgba(0,0,0,0.3)]">
                <div className='ax-[1080px]:mx-auto max-[1080px]:flex-col flex items-center justify-between'>
                    <div className='max-[1080px]:items-center max-xl:items-start max-xl:text-center flex flex-col items-start justify-between h-full text-[100px] overflow-hidden'>
                        <em style={{ fontStyle: "italic", color: "transparent", lineHeight: "1", WebkitTextStroke: "1px #7e1800", }} className='max-[540px]:text-[0.6em] text-[1.2em] max-xl:text-[0.8em] max-xl:mb-[0.3em] libre-baskerville-regular'>07</em>
                        <div>
                            <h3 style={{  letterSpacing: "-0.04em", fontWeight: "600", lineHeight: "1.2", }} className='max-[1080px]:text-center max-xl:text-left max-[540px]:text-[22px] max-[1450px]:text-[34px] text-[max(.4em,22px)] text-[#601301] poppins-bold'>
                    ...
                    <div className='ax-[1080px]:mx-auto max-[768px]:w-full max-[1600px]:w-[460px] relative flex items-center justify-center'>
        ...
        {/* 마지막 섹션 이후 추가 여백 */}
        <div className='max-[1500px]:h-[50vh] max-md:h-[50vh] max-xl:h-[70vh] h-[30vh]'></div>

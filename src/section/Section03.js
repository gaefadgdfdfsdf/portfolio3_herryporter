...
const Section03 = () => {
    ...
    return (
       ...
       <div ref={el => sectionsRef.current[0] = el} className=' w-full h-full mx-auto pt-20 bg-black'>
           <div className=" max-md:ml-10 max-md:mr-10 h-[100vh] bg-white ml-20 mr-20 overflow-hidden pt-28 pb-20 pl-16 pr-16 rounded-[20px] shadow-[0px_0px_30px_rgba(0,0,0,0.3)]">
               <div className='max-[1080px]:flex-col flex items-start justify-between'>
                    <div className='max-[1080px]:mx-auto max-[1080px]:items-center max-xl:text-center flex flex-col max-xl:items-start justify-between h-full text-[100px] overflow-hidden'>
                        ...
                        <div>
                            <h3 style={{  letterSpacing: "-0.04em", fontWeight: "600", lineHeight: "1.2", }} className='max-[1080px]:text-center max-xl:text-left max-[540px]:text-[22px] max-[1450px]:text-[34px] text-[max(.4em,22px)] text-[#601301] poppins-bold pt-5'>
               ...
               <p className='max-[1080px]:hidden max-xl:text-[18px] max-xl:pt-2 tracking-[-0.03em] leading-[1.7] text-[#c3c3c3] text-[24px] libre-baskerville-regular-italic pt-16'>
           ...
           <div className=" max-md:ml-10 max-md:mr-10 h-[100vh] bg-white  ml-20 mr-20 overflow-hidden pt-28 pb-20 pl-16 pr-16 rounded-[20px] shadow-[0px_0px_30px_rgba(0,0,0,0.3)]">
               <div className='max-[1080px]:flex-col flex items-start justify-between'>
                    <div className='max-[1080px]:items-center max-[1080px]:mx-auto max-xl:items-start max-xl:text-center flex flex-col items-start justify-between h-full text-[100px] overflow-hidden'>
                        ...
                        <div>
                            <h3 style={{  letterSpacing: "-0.04em", fontWeight: "600", lineHeight: "1.2", }} className='max-[1080px]:text-center max-xl:text-left max-[540px]:text-[22px] max-[1450px]:text-[34px] text-[#601301] poppins-bold text-[max(.4em,22px)]  pt-5'>
       ...
       <div ref={el => sectionsRef.current[3] = el} className='w-full h-full mx-auto mb-20'>
           <div className=" max-md:ml-10 max-md:mr-10 h-[100vh] bg-white  ml-20 mr-20  overflow-hidden pt-28 pb-20 pl-16 pr-16 rounded-[20px] shadow-[0px_0px_30px_rgba(0,0,0,0.3)]">
               ...
               <p className='max-[1080px]:hidden max-xl:text-[18px] max-xl:pt-6 tracking-[-0.03em] leading-[1.7] text-[#c3c3c3] text-[24px] libre-baskerville-regular-italic pt-16'>

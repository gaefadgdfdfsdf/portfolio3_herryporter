        ...
        <section className='overflow-hidden w-full h-screen relative text-white'>
          ...
          <div className='max-lg:pb-10 flex flex-col justify-between pb-20 box-border relative w-[90%] mx-auto my-0 h-screen'>
            <h2 className='pt-[max(calc(160/920*var(--vh,1vh)*100),100px)]'>
              ...
              <small className='max-[820px]:text-[18px] max-lg:text-[22px] max-xl:text-[24px] pretendard-regular fadein overflow-hidden block text-[26px] tracking-[-0.03em] leading-[1.53] transition-all ease-in-out duration-500'>
            ...
            <div className='max-[820px]:flex-col max-[820px]:items-start max-[820px]:justify-between flex justify-between flex-row-reverse items-end'>
              <div className='max-[820px]:mb-20 fadein text-[max(calc(26/920*var(--vh,1vh)*100),16px)] leading-[1.769]'>
